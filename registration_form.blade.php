                       ...
                       {{ csrf_field() }}
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="hall_name" type="text" class="form-control" name="hall_name" >
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6">
                              <select name="dept" class="form-control">
                                    <option value="volvo">Electrical and Electronics Engineering</option>
                                    <option value="saab">Computer Science Engineering</option>
                                    <option value="fiat">Mechanical Engineering</option>
                                    <option value="audi">Civil Engineering</option>
                                    <option value="audi">Urban and Regional Planning</option>
                                    <option value="audi">Pretrolium and Mining Engineering</option>
                                </select>
